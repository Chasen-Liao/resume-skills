...
// 两侧共用同一份清单（spellcheck 由 Chromium 编辑时注入；data-resume-editor-img-hint 为画布图片失败提示）。
export const editorRuntimeInjectedAttributeNames = ["spellcheck", "data-resume-editor-img-hint"];
