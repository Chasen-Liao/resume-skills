...
- [ ] 补充 YAML frontmatter 元数据（category / tags / languages），提升 `npx skills find` 检索命中率
- [ ] 增加行业关键词清单（Tech / Business / Marketing / Finance），提升 jd-tailorer 定制精度
- [ ] 添加英文 README（English README）